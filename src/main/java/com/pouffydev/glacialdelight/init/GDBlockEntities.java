...
import com.pouffydev.glacialdelight.content.block.pastry_board.PastryBoardBlockEntity;
...
public class GDBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<PastryBoardBlockEntity>> pastryBoard;
    ...
    static {
        ...
        pastryBoard = tiles.register("pastry_board", () -> BlockEntityType.Builder.of(PastryBoardBlockEntity::new, new Block[]{GDBlocks.pastryBoard.get()}).build(null));
