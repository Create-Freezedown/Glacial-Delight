package com.pouffydev.glacialdelight.foundation.util.lang;
...
public class Lang {
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(GlacialDelight.ID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(GlacialDelight.ID);
    }
